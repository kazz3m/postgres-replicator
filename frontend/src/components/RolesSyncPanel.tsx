...
const KIND_LABEL: Record<string, string> = {
  ...
  create_foreign_server:    'FOREIGN SERVER',
  grant_foreign_server:     'GRANT (fdw)',
  create_user_mapping:      'USER MAPPING',
...
const KIND_COLOR: Record<string, string> = {
  ...
  create_foreign_server:    'text-lime-400',
  grant_foreign_server:     'text-lime-300',
  create_user_mapping:      'text-lime-200',
